...
public final class CJKAnalyzer extends StopwordAnalyzerBase {
     ...
     */
    @Deprecated
    public final static String[] STOP_WORDS = { "a", "and", "are", "as", "at", "be",
    ...
    private static class DefaultSetHolder {
        ...
        static final Set<?> DEFAULT_STOP_SET = CharArraySet
                .unmodifiableSet(new CharArraySet(Version.LUCENE_CURRENT, Arrays
                        .asList(STOP_WORDS), false));
    }
    ...
    protected TokenStreamComponents createComponents(String fieldName, Reader reader) {
        ...
        return new TokenStreamComponents(source, new StopFilter(matchVersion, source,
                stopwords));
    }
}
